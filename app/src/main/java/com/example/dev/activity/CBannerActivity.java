 ...
 */
public class CBannerActivity extends BaseActivity implements AdapterView.OnItemClickListener,
    ...
    protected void initContentView(Bundle bundle) {
        setContentView(R.layout.activity_cbanner);
    }
...
//                .setOnPageChangeListener(this)//监听翻页事件
                .setOnItemClickListener(bannerOnItemClickListener);
...
//        convenientBanner.setCanLoop(!convenientBanner.isCanLoop());
     ...
     * Banner Item 点击
     */
    private OnItemClickListener bannerOnItemClickListener = new OnItemClickListener() {
        @Override
